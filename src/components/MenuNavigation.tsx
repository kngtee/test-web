            ...
            >
              ...
              {submenu && (
                <ul className="absolute left-0 mt-10 hover:font-normal bg-white border rounded   text-gray-700 shadow-md w-[200px]">
                  <li className=" py-2 pl-2 hover:font-semibold text-sm">Savings and Investment</li>
                  <li className=" py-2 pl-2 hover:font-semibold text-sm">Protection Policies</li>
                  <li className=" py-2 pl-2 hover:font-semibold text-sm">Endowment Policies</li>
                  <li className=" py-2 pl-2 hover:font-semibold text-sm">Annuities</li>
                  <li className=" py-2 pl-2 hover:font-semibold text-sm">Corporate </li>
                </ul>
              )}
            </li>
            <li className="p-4 w-[full] cursor-pointer flex align-middle hover:font-bold hover:text-[#900000]">
