...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-15 items-center justify-center rounded-full bg-[#F4E6E6] p-3 text-muted-foreground ",
      className
    )}
    {...props}
  />
