      ...
      <div className="mt-4">
        ...
        >
          <TabsList list-style="none">
            ...
            >
              <h6 className="px-[15px] py-[12px]">Make a claim</h6>
            </TabsTrigger>
            <TabsTrigger value="claims" className="outline-none bg-[#F4E6E6]">
              <h6 className="px-[15px] py-[12px]">Claim status</h6>
            </TabsTrigger>
          </TabsList>
                    ...
                    <Form className="px-20 py-10">
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex flex-col gap-6 w-[30%]">
                          ...
                          <Button
                            type="submit"
                            className="bg-[#900000] flex items-center justify-between"
                          >
